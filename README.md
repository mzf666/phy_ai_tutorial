...
0. **TL;DR**: README 的第一段, 放在首图之前, 用三到五句话说清: (a) 动机: 这个技术要解决什么问题, 问题出现在训练侧还是推理侧, 由谁提出 (论文章节); (b) 做法: 一句话说清机制; (c) 收益与代价: 论文披露的数字 (快多少, 慢多少, 换来了什么), 逐值引用. 紧接着一句话说明首图的论点: 读者看图时应该看出什么. 不写背景铺垫, 不写本 module 的目录.
